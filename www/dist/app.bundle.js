...
exports.default = conversionHelper = {
	toLocaleCurrencyString: function toLocaleCurrencyString(amount) {
		var locale = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "USA";

		return this.getSymbolForCountry(locale) + this.toCurrencyString(this.convertFromUSD(locale, amount));
	},
	convertFromUSD: function convertFromUSD(locale, amount) {
		return amount * rates[locale];
	},
	getSymbolForCountry: function getSymbolForCountry(locale) {
		return symbols[locale];
	},
	toCurrencyString: function toCurrencyString(amount) {
...
var _CartItemList = __webpack_require__(41);

var _CartItemList2 = _interopRequireDefault(_CartItemList);

var _itemStore = __webpack_require__(47);

var _itemStore2 = _interopRequireDefault(_itemStore);

var _localizationStore = __webpack_require__(48);

var _localizationStore2 = _interopRequireDefault(_localizationStore);

var _LocalizationBox = __webpack_require__(49);

var _LocalizationBox2 = _interopRequireDefault(_LocalizationBox);

var _TotalBox = __webpack_require__(50);

var _TotalBox2 = _interopRequireDefault(_TotalBox);
...
var CartApp = function (_React$Component) {
    _inherits(CartApp, _React$Component);

    function CartApp() {
        _classCallCheck(this, CartApp);

        return _possibleConstructorReturn(this, (CartApp.__proto__ || Object.getPrototypeOf(CartApp)).apply(this, arguments));
    }
    ...
    _createClass(CartApp, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_LocalizationBox2.default, null),
                ...
                _react2.default.createElement(_CartItemList2.default, this.props),
                _react2.default.createElement(_TotalBox2.default, this.props)
            );
        }
    }]);
...
_itemStore2.default.onChange(function () {
    items = _itemStore2.default.getItems();
    render();
});

_localizationStore2.default.onChange(function () {
    locale = _localizationStore2.default.getLocale();
    render();
});

var render = function render() {
    if (typeof window !== 'undefined') {
        _react2.default.render(_react2.default.createElement(CartApp, { items: items, locale: locale }), document.getElementById('mount'));
    }
};
...
var _CartItem = __webpack_require__(42);

var _CartItem2 = _interopRequireDefault(_CartItem);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = CartItemList = function CartItemList() {
  return _react2.default.createElement(
    'div',
    null,
    undefined.props.items.map(function (item, index) {
      return _react2.default.createElement(_CartItem2.default, { key: "item-" + index, locale: undefined.props.locale, item: item });
    })
  );
};
...
var _conversionHelper = __webpack_require__(21);

var _conversionHelper2 = _interopRequireDefault(_conversionHelper);

var _itemsHelper = __webpack_require__(43);

var _itemsHelper2 = _interopRequireDefault(_itemsHelper);
...
var CartItem = function (_React$Component) {
    ...
    _createClass(CartItem, [{
        ...
        key: 'getLocalizedCurrencySymbol',
        value: function getLocalizedCurrencySymbol() {
            return _conversionHelper2.default.getSymbolForCountry(this.props.locale.country);
        }
    }, {
        key: 'getLocalizedPriceString',
        value: function getLocalizedPriceString() {
            var price = _conversionHelper2.default.convertFromUSD(this.props.locale.country, this.props.item.priceUSD);
            var currencyString = _conversionHelper2.default.toCurrencyString(price);
        ...
        value: function removeItem(e) {
            e.preventDefault();
            _itemsHelper2.default.removeItem(this.props.item);
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'span',
                        { className: 'currencySymbolDisplay' },
                        this.getLocalizedCurrencySymbol()
                    ),
                    _react2.default.createElement(
                        'span',
                        { className: 'cartItemPriceDisplay' },
...
var restHelper = __webpack_require__(13);

exports.default = itemsHelper = {
...
var ItemsStore = function () {
	function ItemsStore() {
		...
		restHelper.get('items').then(function (itemData) {
			items = itemData;
		...
		dispatcher.register(function (e) {
			var _e$type$split = e.type.split(':'),
			    ...
			    category = _e$type$split2[0],
			    type = _e$type$split2[1];

			if (category === "items") {
				if (type === "remove") {
					items = items.filter(function (a) {
						return a.id !== e.item.id;
					});
					_this.triggerListeners();
				}
			}
...
var LocalizationStore = function () {
	function LocalizationStore() {
		...
		restHelper.get('locale').then(function (locale) {
			localeInfo = locale;
			_this.triggerListeners();
		});
...
var LocalizationBox = function (_React$Component) {
	_inherits(LocalizationBox, _React$Component);

	function LocalizationBox() {
		_classCallCheck(this, LocalizationBox);

		return _possibleConstructorReturn(this, (LocalizationBox.__proto__ || Object.getPrototypeOf(LocalizationBox)).apply(this, arguments));
	}

	_createClass(LocalizationBox, [{
		key: 'handleCountryChange',
		value: function handleCountryChange(_ref) {
		...
		value: function render() {
			return _react2.default.createElement(
				'form',
				{ role: 'Language and Currency Preferences', className: 'locale-form' },
				_react2.default.createElement(
					'h4',
					null,
					'Select Country'
				...
				_react2.default.createElement(
					'select',
					{ name: 'country', id: 'countrySelect', onChange: this.handleCountryChange, value: this.state.country },
					_react2.default.createElement(
						'option',
						{ value: 'USA' },
						'United States'
...
exports.default = LocalizationBox;
...
module.exports = _react2.default.createClass({
	displayName: 'exports',
	calculateTotalItemPrices: function calculateTotalItemPrices() {
		return _d2.default.sum(this.props.items, function (i) {
			return i.priceUSD;
		});
	},
	getTotalString: function getTotalString() {
		return _conversionHelper2.default.toLocaleCurrencyString(this.calculateTotalItemPrices(), this.props.locale.country);
	},

	render: function render() {
		return _react2.default.createElement(
			'section',
			{ role: 'cart total', className: 'total' },
			_react2.default.createElement(
				'h3',
				null,
				'Your Total'
